...
These are the six self-hosted latin-subset faces that make up the site's type
system — Source Serif 4 for display and body, IBM Plex Sans as the candidate
sans body face, IBM Plex Mono for metadata, labels and code — declared in
`src/styles/portfolio.css` and shipped with the site.
...
Total: **118056 bytes** (6 files).

Retrieved 2026-09-16 from the Bunny Fonts CSS API
(`https://fonts.bunny.net/css?family=ibm-plex-sans:400,600`), keeping only the
